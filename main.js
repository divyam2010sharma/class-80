...
function sorting()
	{
		...
		var lenght_of_name_array = names_of_people_array.length
		console.log(lenght_of_name_array; k++)

		for (var k = 0; k < lenght_of_name_array; k++)
		{
			display_name_array_sorting.push("<h4>GUEST -"+ names_of_people_array[k] +"</h4>");
